<div class="container is-fluid mb-6">
	...
	<h2 class="subtitle"><i class="fas fa-hand-holding-usd fa-fw"></i> &nbsp; Nueva compra</h2>
</div>
        ...
        <div class="column is-one-quarter">
            ...
            <?php } ?>
                ...
                <div class="control mb-5">
                    ...
                    <input class="input" type="text" name="proveeedor" id="proveeedor" value="" pattern="[0-9.]{1,25}" maxlength="25" >
                </div>
                ...
                <div class="control mb-5">
                    <label>Monto a pagar a proveedor <?php echo CAMPO_OBLIGATORIO; ?></label>
